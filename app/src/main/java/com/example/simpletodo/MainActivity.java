...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // onclick handler for Add button in app
    ...
    private void loadItems(){
        try {
            items = new ArrayList<String>(readLines(getDataFiles(), Charset.defaultCharset()));
        }catch (IOException e){
            Log.e("MainActivity", "Error reading items", e);
            items = new ArrayList<>();
        }
    }
    // This functions aves items by writing them into data file
    private void saveItems(){
        try {
            writeLines(getDataFiles(),items);
        }catch (IOException e){
            Log.e("MainActivity", "Error reading items", e);
        }
